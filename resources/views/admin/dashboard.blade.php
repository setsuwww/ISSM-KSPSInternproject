    ...
    <div class="min-h-screen bg-white p-4 sm:p-6 lg:p-8">
            ...
            <div class="bg-white rounded-xl p-4 sm:p-6 border border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                    <div class="flex items-center space-x-3 sm:space-x-4">
                        <div class="p-2 sm:p-3 bg-sky-100 rounded-xl border border-sky-200">
                    ...
                    <div class="text-left sm:text-right">
                        ...
                        <div class="text-xs text-gray-400">Last updated: {{ now()->format('H:i') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-4 sm:p-6">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0 mb-6">
                    <div class="flex items-center space-x-3">
                        <div class="p-3 bg-sky-100 rounded-lg border border-sky-200">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-4 sm:p-6">
                <div class="flex flex-col space-y-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <p class="text-xs sm:text-sm font-medium text-gray-600">Total Schedules</p>
                            <p class="text-xl sm:text-2xl font-bold text-gray-900">{{ number_format($totalSchedules) }}</p>
                        </div>
                    </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-4 sm:p-6">
            <div class="flex items-center space-x-3 mb-4 sm:mb-6">
                <div class="p-3 bg-yellow-100/60 rounded-lg border border-yellow-200">
                    <i data-lucide="zap" class="w-5 h-5 sm:w-6 sm:h-6 text-yellow-600"></i>
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                <a href="{{ route('admin.users.create') }}"
                    ...
                    <div class="p-3 bg-sky-100 rounded-lg border border-sky-200 mr-3 flex-shrink-0">
                    ...
                    <div class="min-w-0 flex-1">
                        <p class="text-sm sm:text-base font-medium text-gray-800 group-hover:text-sky-700 truncate">Add User
                        </p>
